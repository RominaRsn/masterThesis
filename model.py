...
def encoder_with_7_layers_less_filter(input_shape=(500,1)):
    # Define the input layer
    input_layer = Input(shape=(500, 1))  # Assuming 1 channel (e.g., for time series data)
    ...
    encoded5 = Conv1D(128, 3, activation='relu',kernel_initializer='he_uniform', padding='same')(encoded4)
    encoded5 = MaxPooling1D(2, padding='same')(encoded5)

    encoded6 = Conv1D(128, 3, activation='relu',kernel_initializer='he_uniform', padding='same')(encoded5)
    encoded6 = MaxPooling1D(2, padding='same')(encoded6)

    encoded7 = Conv1D(128, 3, activation='relu',kernel_initializer='he_uniform', padding='same')(encoded6)
    encoded7 = MaxPooling1D(2, padding='same')(encoded7)


    # Decoding layers (symmetric to the encoding layers)
    decoded7 = Conv1D(128, 3, activation='relu',kernel_initializer='he_uniform', padding='same')(encoded7)
    decoded7 = UpSampling1D(2)(decoded7)

    decoded6 = Conv1D(128, 3, activation='relu',kernel_initializer='he_uniform', padding='same')(decoded7)
    decoded6 = UpSampling1D(2)(decoded6)

    decoded5 = Conv1D(128, 3, activation='relu',kernel_initializer='he_uniform', padding='same')(encoded5)
    decoded5 = UpSampling1D(2)(decoded5)
...
def encoder_with_7_layers(input_shape=(500,1)):
    # Define the input layer
    input_layer = Input(shape=(500, 1))  # Assuming 1 channel (e.g., for time series data)
    ...
    encoded7 = Conv1D(256, 3, activation='relu',kernel_initializer='he_uniform', padding='same')(encoded6)
    encoded7 = MaxPooling1D(2, padding='same')(encoded7)


    # Decoding layers (symmetric to the encoding layers)
    decoded7 = Conv1D(256, 3, activation='relu',kernel_initializer='he_uniform', padding='same')(encoded7)
    decoded7 = UpSampling1D(2)(decoded7)

    decoded6 = Conv1D(256, 3, activation='relu',kernel_initializer='he_uniform', padding='same')(decoded7)
    decoded6 = UpSampling1D(2)(decoded6)
...
def encoder_with_512_filters(input_shape=(500,1)):
    # Define the input layer
    input_layer = Input(shape=(500, 1))  # Assuming 1 channel (e.g., for time series data)

    # Encoding layers
    encoded1 = Conv1D(512, 3, activation='relu',kernel_initializer='he_uniform', padding='same')(input_layer)
    encoded1 = MaxPooling1D(2, padding='same')(encoded1)

    encoded2 = Conv1D(512, 3, activation='relu',kernel_initializer='he_uniform', padding='same')(encoded1)
    encoded2 = MaxPooling1D(2, padding='same')(encoded2)

    encoded3 = Conv1D(512, 3, activation='relu',kernel_initializer='he_uniform', padding='same')(encoded2)
    encoded3 = MaxPooling1D(2, padding='same')(encoded3)

    encoded4 = Conv1D(512, 3, activation='relu',kernel_initializer='he_uniform', padding='same')(encoded3)
    encoded4 = MaxPooling1D(2, padding='same')(encoded4)

    encoded5 = Conv1D(512, 3, activation='relu',kernel_initializer='he_uniform', padding='same')(encoded4)
    encoded5 = MaxPooling1D(2, padding='same')(encoded5)

    # encoded6 = Conv1D(512, 3, activation='relu',kernel_initializer='he_uniform', padding='same')(encoded5)
    # encoded6 = MaxPooling1D(2, padding='same')(encoded6)
    #
    # encoded7 = Conv1D(512, 3, activation='relu',kernel_initializer='he_uniform', padding='same')(encoded6)
    # encoded7 = MaxPooling1D(2, padding='same')(encoded7)


    # Decoding layers (symmetric to the encoding layers)
    # decoded7 = Conv1D(512, 3, activation='relu',kernel_initializer='he_uniform', padding='same')(encoded7)
    # decoded7 = UpSampling1D(2)(decoded7)
    #
    # decoded6 = Conv1D(512, 3, activation='relu',kernel_initializer='he_uniform', padding='same')(decoded7)
    # decoded6 = UpSampling1D(2)(decoded6)

    decoded5 = Conv1D(512, 3, activation='relu',kernel_initializer='he_uniform', padding='same')(encoded5)
    decoded5 = UpSampling1D(2)(decoded5)

    decoded4 = Conv1D(512, 3, activation='relu',kernel_initializer='he_uniform', padding='same')(encoded4)
    decoded4 = UpSampling1D(2)(decoded4)

    decoded3 = Conv1D(512, 3, activation='relu',kernel_initializer='he_uniform', padding='same')(encoded3)
    decoded3 = UpSampling1D(2)(decoded3)

    decoded2 = Conv1D(512, 3, activation='relu',kernel_initializer='he_uniform', padding='same')(decoded3)
    decoded2 = UpSampling1D(2)(decoded2)

    decoded1 = Conv1D(512, 3, activation='relu',kernel_initializer='he_uniform', padding='valid')(decoded2)
    decoded1 = UpSampling1D(2)(decoded1)

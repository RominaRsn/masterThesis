...
filteredSignal_45 = nk.signal_filter(noisy_test, sampling_rate=250, lowcut=0.1, highcut=45, method='butter', order=4)
filteredSignal_70 = nk.signal_filter(noisy_test, sampling_rate=250, lowcut=0.1, highcut=70, method='butter', order=4)
filteredSignal_30 = nk.signal_filter(noisy_test, sampling_rate=250, lowcut=0.1, highcut=30, method='butter', order=4)
...
for i in range(0, 6):
    ...
    axes[3].plot(filteredSignal_45[row_index, :], label = 'filtered signal-45')
    ...
    axes[3].plot(filteredSignal_70[row_index, :], label = 'filtered signal-70')
    axes[3].set_title('filtered signal-70')
    axes[3].set_ylabel('Signal amplitude')
    axes[3].set_xlabel('Time')
